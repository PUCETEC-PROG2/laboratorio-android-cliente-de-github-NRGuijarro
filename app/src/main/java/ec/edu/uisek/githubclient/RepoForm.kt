...
class RepoForm : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        repoFormBinding.buttonCancel.setOnClickListener { finish() }
        repoFormBinding.buttonSave.setOnClickListener { createRepo() }
    }
    ...
    private fun createRepo() {
        ...
        val repoName = repoFormBinding.nameRepoInputForm.text.toString()
        val repoDescription = repoFormBinding.nameRepoInputForm.text.toString()
